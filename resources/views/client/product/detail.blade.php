...
@section('content')
    ...
    <div class="container p-t-80">
        <div class="bread-crumb flex-w p-l-25 p-r-15 p-t-30 p-lr-0-lg">
            ...
            <a href="{{\Str::slug($product->menu->name)}}.html" class="stext-109 cl8 hov-cl1 trans-04">
                {{$product->menu->name}}
                <i class="fa fa-angle-right m-l-9 m-r-10" aria-hidden="true"></i>
            </a>
                            ...
                            <div class="slick3 gallery-lb slick-initialized slick-slider slick-dotted">
                                <div class="slick-list draggable">
                                    <div class="slick-track" style="opacity: 1; width: 1539px;">
                                        ...
                                        <div class="item-slick3 slick-slide" data-thumb="images/product-detail-02.jpg"
                                        ...
                                        <div class="item-slick3 slick-slide" data-thumb="images/product-detail-03.jpg"
                ...
                <div class="tab01">
                    ...
                    <ul class="nav nav-tabs" role="tablist">
                        <li class="nav-item p-b-10">
                            <a class="nav-link active" data-toggle="tab" href="#description" role="tab">Chi tiết sản
                                phẩm</a>
                        </li>
