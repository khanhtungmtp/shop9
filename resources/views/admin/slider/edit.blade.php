    ...
    <form action="" method="POST">
        <div class="card-body">
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" name="title" value="{{$slider->title}}" class="form-control"  placeholder="Nhập tên sản phẩm">
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                        <label>Thứ tự</label>
                        <input type="text" name="sort_by" class="form-control" id="sort_by" value="{{$slider->sort_by}}">
                    </div>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div id="image_show">
                    <a href="{{$slider->thumb}}">
                        <img src="{{$slider->thumb}}" alt="" width="150px">
                    </a>
                </div>
